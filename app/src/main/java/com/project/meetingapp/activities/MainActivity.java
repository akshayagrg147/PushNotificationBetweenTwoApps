...
//        FirebaseInstanceId.getInstance().getToken();
        ...
        if (user.token == null || user.token.trim().isEmpty()) {
            ...
            FirebaseInstanceId.getInstance().getInstanceId().addOnCompleteListener(task -> {
                if (task.isSuccessful() && task.getResult() != null) {
                      ...
                      initiateMeeting("video", user.token);
    ...
    private void initiateMeeting(String meetingType, String receiverToken) {
        ...
        try {
            ...
            data.put(Constants.REMOTE_MSG_MEETING_ROOM, "djnjsnjdnsjndsj");
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                if (response.isSuccessful()) {
                    if (type.equals(Constants.REMOTE_MSG_INVITATION)) {
                        Toast.makeText(MainActivity.this, "Invitation sent successfully", Toast.LENGTH_SHORT).show();
                    } else if (type.equals(Constants.REMOTE_MSG_INVITATION_RESPONSE)) {
                        Toast.makeText(MainActivity.this, "Invitation cancelled", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                } else {
